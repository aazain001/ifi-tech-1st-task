...
AS
 BEGIN
    ...
    -- the timezone is no longer hardcoded to AUS Eastern Standard Time. It is read from
    -- ELT.Config so a non-Australian deployment only needs to update that config row,
    -- not this function.
