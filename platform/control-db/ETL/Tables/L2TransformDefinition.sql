CREATE TABLE [ELT].[L2TransformDefinition] (
    ...
    [CreatedTimestamp]             DATETIME       CONSTRAINT [DC_L2TransformDefinition_CreatedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NOT NULL,
    [ModifiedBy]                   NVARCHAR (128) CONSTRAINT [DC_L2TransformDefinition_ModifiedBy] DEFAULT (suser_sname()) NULL,
    [ModifiedTimestamp]            DATETIME       CONSTRAINT [DC_L2TransformDefinition_ModifiedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NULL,
