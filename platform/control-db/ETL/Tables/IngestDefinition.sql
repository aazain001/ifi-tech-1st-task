CREATE TABLE [ELT].[IngestDefinition] (
    ...
    [CreatedTimestamp]          DATETIME       CONSTRAINT [DC_IngestDefinition_CreatedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NOT NULL,
    [ModifiedBy]                NVARCHAR (128) CONSTRAINT [DC_IngestDefinition_ModifiedBy] DEFAULT (suser_sname()) NULL,
    [ModifiedTimestamp]         DATETIME       CONSTRAINT [DC_IngestDefinition_ModifiedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NULL,
