CREATE TABLE [ELT].[ColumnMapping] (
    ...
    [CreatedTimestamp]      DATETIME       CONSTRAINT [DC_Attribute_CreatedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NOT NULL,
    [ModifiedBy]            VARCHAR (128)  CONSTRAINT [DC_Attribute_ModifiedBy] DEFAULT (suser_sname()) NULL,
    [ModifiedTimestamp]     DATETIME       CONSTRAINT [DC_Attribute_ModifiedTimestamp] DEFAULT ([ELT].[uf_GetAestDateTime]()) NULL,
